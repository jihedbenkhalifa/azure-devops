...
{
    [TestClass]
    public partial class ConfigurationItemServiceFixture
    {
        [TestInitialize]
        public void OnTestInitialize()
        {
            _systemUnderTest = null;
            _ConfigurationItemRepositoryInstance = null;
            _ValidatorStrategy = null;
            _UsernameProvider = null;
        }
        
        private ConfigurationItemService _systemUnderTest;
        
        private ConfigurationItemService SystemUnderTest
        {
            get
            {
                ...
                {
                    _systemUnderTest =
                    new ConfigurationItemService(
                    ConfigurationItemRepositoryInstance,
                    ValidatorStrategy,
                    UsernameProvider,
        ...
        private InMemoryConfigurationItemRepository _ConfigurationItemRepositoryInstance;
        public InMemoryConfigurationItemRepository ConfigurationItemRepositoryInstance
        {
            get
            {
                if (_ConfigurationItemRepositoryInstance == null)
                {
                    _ConfigurationItemRepositoryInstance = new InMemoryConfigurationItemRepository();
                }
                
                return _ConfigurationItemRepositoryInstance;
            }
        }
        
        private FakeValidatorStrategy<ConfigurationItem> _ValidatorStrategy;
        public FakeValidatorStrategy<ConfigurationItem> ValidatorStrategy
        {
            get
            {
                if (_ValidatorStrategy == null)
                {
                    _ValidatorStrategy = new FakeValidatorStrategy<ConfigurationItem>();
                }
        ...
        {
            var items = ConfigurationItemTestUtility.CreateEntities();
            
            foreach (var item in items)
            {
                ConfigurationItemRepositoryInstance.Save(item);
            }
        }
        ...
        public void GetAll_WithDataInRepository_ReturnsData()
        {
            ...
            var expectedCount = ConfigurationItemRepositoryInstance.Items.Count();
            
            // act
            var actual = SystemUnderTest.GetAll();
            
            // assert
            Assert.IsTrue(ConfigurationItemRepositoryInstance.WasGetAllCalled, "Repository's GetAll() method was not called.");
        ...
        public void GetById_ForKnownId_ReturnsResult()
        {
            // arrange
            PopulateRepositoryWithTestData();
            var expected = ConfigurationItemRepositoryInstance.Items[2];
            
            // act
            var actual = SystemUnderTest.GetById(expected.Id);
            
            // assert
            Assert.IsTrue(ConfigurationItemRepositoryInstance.WasGetByIdCalled, "Repository's GetById() method was not called.");
            Assert.IsNotNull(actual);
        }
        ...
        public void Save_NewValidItem_IdIsPopulatedAndIsInRepository()
        {
            ...
            Assert.IsTrue(ConfigurationItemRepositoryInstance.WasSaveCalled, "Save was not called.");
            var actual = ConfigurationItemRepositoryInstance.GetById(saveThis.Id);
            Assert.IsNotNull(actual, "Item wasn't saved to repository.");
            
            var entity = ConfigurationItemRepositoryInstance.GetById(saveThis.Id);
            Assert.IsNotNull(entity, "Entity wasn't saved to repository.");
            ConfigurationItemTestUtility.AssertAreEqual(saveThis, entity);
        }
        ...
        public void Save_ModifiedValidItem_CreatedAndLastUpdatedFieldsArePopulated()
        {
            // arrange
            PopulateRepositoryWithTestData();
            var savedEntity = ConfigurationItemRepositoryInstance.Items[2];
            ...
            ConfigurationItemTestUtility.ModifyModel(saveThis);
            
            ConfigurationItemRepositoryInstance.ResetMethodCallTrackers();
        ...
        public void Save_NewInvalidItem_DoesNotGetSavedAndThrowsValidationException()
        {
            ...
            Assert.IsFalse(ConfigurationItemRepositoryInstance.WasSaveCalled, "Save should not be called.");
        }
        ...
        public void Delete_RemovesItemFromRepository()
        {
            ...
            // assert
            Assert.IsTrue(ConfigurationItemRepositoryInstance.WasDeleteByIdCalled, "DeleteById was not called.");
